...
To run the code:
First run `triangles_paper_code.ipynb`. This computes the data for various mesh sizes and stores it as a dictionary. 

Next run `triangles_paper_plots.ipynb`. This reads from the stored dictionaries and reproduces the plots in the paper. 
